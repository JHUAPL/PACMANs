...
def box_model(box_dimensions: BoxModelBoxDimensions,
    ...
    :param randomization: (BoxModelRandomization) Settings for how random number generation should work during the run
    """
    ...
    M_SD, Fws0, Fwn0, epsilon = box_params.M_SD, box_params.Fws, box_params.Fwn, box_params.epsilon
    ...
    for step in range(0, N):
        ...
        Fws = Fws0 + randomization.sample()
        Fwn = Fwn0 + randomization.sample()
