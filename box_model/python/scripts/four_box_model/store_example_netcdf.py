...
from pybamocs.four_box_model.box_model import box_model, NORTH_IDX, SOUTH_IDX, LOW_IDX, DEEP_IDX
from pybamocs.four_box_model.box_model_args import box_args_from_dict, dict_from_box_args
from pybamocs.four_box_model.box_storage import store_run
...
def main(netcdf_fp):
    BOX_ARGS_BASE = dict(N=4000, K_v=1e-5, A_GM=1000, M_ek=25e6, A_Redi=1000, M_SD=15e6, D_low0=400,
                         ...
                         rng_seed=0, noise_amplification=0
                         )
